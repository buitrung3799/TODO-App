    ...
    return(
        <div className="col-lg-10 offset-lg-1 col-md-10 col-sm-12 col-xs-12">
            <nav style={{marginTop: "60px"}}>
                ...
                <li className={"breadcrumb-item" + (props.visibilityFilter === SHOW_ALL ? 'active' : '')}
                onClick={() => props.setVisibilityFilter(SHOW_ALL)}
                style={{cursor: 'pointer'}}
                >
                    ALL
                </li>
                <li className={"breadcrumb-item" + (props.visibilityFilter === SHOW_COMPLETED ? 'active' : '')}
                onClick={() => props.setVisibilityFilter(SHOW_COMPLETED)}
                style={{cursor: 'pointer'}}>
                    COMPLETED
                </li>
                <li className={"breadcrumb-item" + (props.visibilityFilter === SHOW_ACTIVE ? 'active' : '')}
